...
class ApproveVacationOrHospitalApiTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function setUp(): void
    {
        ...
        $this->api_url_for_hr = 'api/v1/hr/vacation/'.$this->hospital_worker->id.'/accept';
        $this->api_url_for_admin = 'api/v1/admin/vacation/'.$this->hospital_hr->id.'/accept';
    }

    public function test_approve_vacation_or_hospital_request_for_worker_by_hr_success()
    {
    ...
    public function test_approve_vacation_or_hospital_request_for_hr_by_admin_success()
    {
    ...
    public function test_approve_vacation_or_hospital_request_for_hr_forbidden_by_role()
    {
    ...
    public function test_approve_vacation_or_hospital_request_for_worker_forbidden_by_role()
    {
        $this->admin->role_id = User::ADMIN_ROLE_ID;
        $this->actingAs($this->admin);
