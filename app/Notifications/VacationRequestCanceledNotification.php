...
class VacationRequestCanceledNotification extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ->line(__('notifications.vacation_request_canceled_title', ['date' => $this->vacation->getDateStart()]))
            ->line(
                __(
                    'notifications.vacation_request_canceled_text',
                    [
