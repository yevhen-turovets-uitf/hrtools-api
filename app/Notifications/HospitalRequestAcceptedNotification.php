...
class HospitalRequestAcceptedNotification extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ->line(__('notifications.hospital_request_accepted_title', ['date' => $this->hospital->getDateStart()]))
            ->line(
                __(
                    'notifications.hospital_request_accepted_text',
                    [
